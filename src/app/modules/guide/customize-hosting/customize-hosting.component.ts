...
@Component({
  selector: 'app-customize-hosting',
  templateUrl: './customize-hosting.component.html',
  styleUrls: ['./customize-hosting.component.css']
})
export class CustomizeHostingComponent implements AfterViewInit, OnDestroy{
    ...
    ngAfterViewInit() {
        ...
        this.communication.sendResource({type : 'resource', appHeader : 'Настройка поведения'})
    }
